...
export function ProductItem({ product }) {
    ...
    return (
        <div className="flex flex-col justify-between border-gray-100 dark:border-gray-800 cursor-pointer border border-gray-200" id={product.id}>
            ...
            <button data-product-id={product.id} className="addToCart font-semibold bg-indigo-700 dark:bg-gray-800 py-2 px-2 text-gray-300 w-full" onClick={AddtoCart}>Add to cart</button>
        </div>
    )
}
